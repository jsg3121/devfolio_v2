    ...
    career: [
      ...
      },
      {
        ...
        description: [
          ...
          'Redux를 사용하여 STB의 펌웨어 버전, 리모컨의 펌웨어버전, 운영되고 있는 앱의 버전관리를 위한 데이터 상태관리 구현',
      ...
      },
      {
        ...
        description: [
          'Vue를 이용하여 제작된 실제 서비스중인 서경방송 STB(셋톱박스) 런처 앱 유지보수',
          '방송정보 수신, VOD 데이터 결제 요청 및 관리 API를 이용하여 기능 개선',
          'Vuex를 통한 상태관리를 이용하여 월정액 가입 채널, 유료 VOD등의 정보를 조회하고 관리하는 기능 수정',
